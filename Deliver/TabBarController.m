...
- (void)initMainView {
    ...
    JTNavigationController *nav2 = [[JTNavigationController alloc] initWithRootViewController:[[MainViewController alloc] init]];
    ...
    JTNavigationController *nav3 = [[JTNavigationController alloc] initWithRootViewController:[[MainViewController alloc] init]];
